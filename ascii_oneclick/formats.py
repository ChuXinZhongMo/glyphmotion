...
OUTPUT_FORMATS: tuple[OutputFormat, ...] = (
    ...
    OutputFormat("webm", "WebM 全彩视频", default=False, requires_tool="ffmpeg"),
    OutputFormat("hevc", "HEVC 全彩视频 (.mp4)", default=False, requires_tool="ffmpeg"),
    OutputFormat("mov", "MOV ProRes 全彩 (.mov)", default=False, requires_tool="ffmpeg"),
    OutputFormat("av1", "AV1 全彩视频 (.mp4)", default=False, requires_tool="ffmpeg"),
